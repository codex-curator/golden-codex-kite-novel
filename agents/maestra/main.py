...
def settle_payment(to_address, amount_usd, service, job_id):
    ...
    chain_label = "kite-mainnet" if network == "kite" else "base-mainnet"
...
def health():
    ...
    return jsonify({
        "status": "healthy",
        "agent": OPERATOR_ID,
        "persona": "Maestra (Autonomous Frontier Lab Vision AI Purchasing Agent)",
        "mandate_budget_usd": MAESTRA_MANDATE_BUDGET_USD,
        "mandate_tier": MAESTRA_MANDATE_TIER,
        "mandate_domain": MAESTRA_MANDATE_DOMAIN,
        "autonomous_mode": MAESTRA_AUTONOMOUS_MODE,
        "gcx_bar_url": GCX_BAR_URL,
        "cocktail_priming": COCKTAIL_SLUG,
