...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --max-instances=1 \
  --timeout=120 \
  --set-env-vars="GCP_PROJECT=${PROJECT_ID},FIRESTORE_DB=golden-codex-database,AEGIS_URL=https://aegis-agent-172867820131.us-west1.run.app,X402_NETWORK=${X402_NETWORK:-kite},METAVOLVE_WALLET=0xFE141943a93c184606F3060103D975662327063B,ARTISWA_USER_ID=2019690975011172361,B1ANK_USER_ID=2019692766843006981,GOLDEN_CODEX_USER_ID=1995768015900807168,EXCEPTIONAL_THRESHOLD=${EXCEPTIONAL_THRESHOLD:-9.0},DEFAULT_TOPUP_USD=${DEFAULT_TOPUP_USD:-20.0},PENDING_EXPIRY_MINUTES=${PENDING_EXPIRY_MINUTES:-15},COLLECTOR_NOTIFICATION_WEBHOOK=${COLLECTOR_NOTIFICATION_WEBHOOK:-},PUBLIC_BASE_URL=${PUBLIC_BASE_URL:-}" \
